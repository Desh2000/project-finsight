...
from ml.trainer import ensure_model_ready

# Create all database tables on startup
Base.metadata.create_all(bind=engine)

# Ensure the ML risk model is trained and serialised before serving requests
ensure_model_ready()

app = FastAPI(
    title="FinSight Savings Goal & Portfolio Analytics Service",
